                                                    ...
                                                    do 
                                                        ...
                                                        do  
                                                            ...
                                                            do
                                                                ...
                                                                touch ./bash/$domain_folder/$model_folder/$layer_folder/run.sh
                                                                tee ./bash/$domain_folder/$model_folder/$layer_folder/run.sh << EOF
#!/bin/bash
