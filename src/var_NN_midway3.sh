                                                    ...
                                                    do 
                                                        ...
                                                        do  
                                                            ...
                                                            do
                                                                ...
                                                                touch ./bash/$domain_folder/$model_folder/$layer_folder/var.sh
                                                                tee ./bash/$domain_folder/$model_folder/$layer_folder/var.sh << EOF
#!/bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=var
#SBATCH --output=./job-outs/$domain_folder/$model_folder/$layer_folder/var.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/$layer_folder/var.err
...
EOF
                                                                sbatch ./bash/$domain_folder/$model_folder/$layer_folder/var.sh
                                                            done
                                                        done
                                                    done
                                                done        
